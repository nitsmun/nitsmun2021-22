    ...
    return (
        ...
        <div id="carouselExampleCaptions" className="carousel slide" data-bs-ride="carousel">
            ...
            <div className="carousel-inner">
                ...
                <div className="carousel-item">
                    <img loading="lazy" src="img/Carousel5.jpg" className="d-block img-fluid" alt="NITS MUN"/>
                </div>
                <div className="carousel-item">
                    <img loading="lazy" src="img/Carousel6.jpg" className="d-block img-fluid" alt="NITS MUN"/>
                </div>
                <div className="carousel-item">
                    <img loading="lazy" src="img/Carousel7.jpg" className="d-block img-fluid" alt="NITS MUN"/>
                </div>
            </div>
