  ...
  return (
    <div className="container" style={{ fontFamily: "var(--font2)" }}>
      ...
      <div className="sponser my-5" style={{ display: "flex" }}>
        ...
        >
          <a href="https://www.thedais.co.in/">
            <img
              src="../img/dias_logo.jpg"
              className="img-fluid"
      ...
      <div className="sponser my-5" style={{ display: "flex" }}>
        <div
          className="dias author"
          style={{ display: "flex", justifyContent: "flex-start" }}
        >
          <img
            src="../img/Parinda Joshi.png"
            className="img-fluid"
            style={{ width: "100px", borderRadius: "50%" }}
            alt="thedias"
          />
        ...
        <div className="dias author" style={{ display: "flex" }}>
          <img
            src="../img/Photograph_MohitParikh.png"
            className="img-fluid"
            style={{ width: "100px", borderRadius: "50%" }}
            alt="ids"
          />
